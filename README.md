...
> [!NOTE]
> Каталоги `assets`, `diagrams`, `examples`, `images` и `scripts` будут постепенно наполняться схемами, скриншотами, примерами конфигураций и вспомогательными сценариями.
